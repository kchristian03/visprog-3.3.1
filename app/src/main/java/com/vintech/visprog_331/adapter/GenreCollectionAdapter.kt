...
class GenreCollectionAdapter(private val dataSet: List<Genre>) :
    RecyclerView.Adapter<GenreCollectionAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.card_genre_collection, viewGroup, false)
